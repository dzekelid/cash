...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/cash/master/_listings/square/apis.md
...
- name: Square Connect - Provides the details for all of a location's cash drawer
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/cash/master/_listings/square/v1location-idcashdrawershifts-get-openapi.md
- name: Square Connect - Provides the details for a single cash drawer shift, including
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/cash/master/_listings/square/v1location-idcashdrawershiftsshift-id-get-openapi.md
x-common:
- type: x-website
  url: http://square.com
- type: x-api-gallery
